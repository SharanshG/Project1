 ...
 * @notice https://github.com/ethereum/EIPs/issues/20
 */
contract Token is IERC20, BasicToken {
...
/**
 * @title Sharansh Token
 * @dev Simple ERC20 Token with standard token functions.
 */
contract SharanshToken is Token {
  string public constant NAME = "Sharansh Token";
  ...
  /**
   * Sharansh Token Constructor
   * @dev Create and issue tokens to msg.sender.
   */
  //function SharanshToken() public {
    constructor () public {
...
/**
 * @title Token
 * @dev API interface for interacting with the SGT Token contract 
 */
interface SGToken {
...
/**
 * @title SharanshICO
 * @dev SharanshICO contract is Ownable
 **/
contract SharanshICO is Ownable {
  using SafeMath for uint256;
  SGToken token;

  uint256 public constant RATE = 1000; // Number of Sharansh tokens per Ether
  uint256 public constant CAP = 5000; // Cap in Ether
  uint256 public constant START = 1643033418; // Jan 24, 2022 @ 02:10 GMT
  ...
  /**
   * SharanshICO
   * @dev SharanshICO constructor
   **/
  //function SharanshICO(address _tokenAddr) public {
  constructor (address _tokenAddr) public {
      require(_tokenAddr != 0);
      token = SGToken(_tokenAddr);
  }
